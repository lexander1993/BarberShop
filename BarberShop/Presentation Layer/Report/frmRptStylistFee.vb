Public Class frmRptStylistFee
    ...
    Private Sub prvPreview()
        ...
        Dim crReportFile As New rptStylistFee
        crReportFile.SetDataSource(DL.PaymentIn.StylistFeeReport(dtpDateFrom.Value.Date, cbStylistUserID.Text))
...
#Region "Form Handle"
    ...
    Private Sub frmRptSummaryLocalPurchaseByCategory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtReportTitle.Text = "Stylist Fee Report"

        cbStylistUserID.DataSource = DL.StylistQueue.ListStylistAllName
        cbStylistUserID.DisplayMember = "UserID"
        cbStylistUserID.ValueMember = "UserID"
        cbStylistUserID.SelectedIndex = -1
    End Sub
