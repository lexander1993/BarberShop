...
Public Class rptStylistFee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarberShop.rptStylistFee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStylistFee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStylistFee = New rptStylistFee()
        rpt.Site = Me.Site
        Return rpt
    End Function
