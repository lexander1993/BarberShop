...
Public Class rptStylistFeeSmall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarberShop.rptStylistFeeSmall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStylistFeeSmall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStylistFeeSmall = New rptStylistFeeSmall()
        rpt.Site = Me.Site
        Return rpt
    End Function
