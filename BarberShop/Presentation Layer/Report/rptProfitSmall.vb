...
Public Class rptProfitSmall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarberShop.rptProfitSmall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProfitSmall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProfitSmall = New rptProfitSmall()
        rpt.Site = Me.Site
        Return rpt
    End Function
